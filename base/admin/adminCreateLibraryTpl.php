<?php if ($_GET['action'] == "createLibrary") { ?>
  ...
  <form class="form-horizontal" method="POST" action="">
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control" placeholder="libraryDirectory" name="libraryDirectory"
               value="<?php echo isset($_POST['libraryDirectory']) ? $_POST['libraryDirectory'] : "queryLib"; ?>"/>
      </div>
    </div>
    <div class="form-group">
      <label class="col-sm-3 control-label">Library Name:</label>
      <div class="col-sm-8">
        <input type="text" class="form-control" placeholder="libraryName" name="libraryName"
               value="<?php echo isset($_POST['libraryName']) ? $_POST['libraryName'] : ""; ?>"/>
      </div>
    </div>
    <br/>
    <hr/>
