<?php if ($_GET['action'] == "createModule") { ?>
  ...
  <form class="form-horizontal" method="POST" action="">
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control" placeholder="module" name="moduleName"
               value="<?php echo isset($_POST['moduleName']) ? $_POST['moduleName'] : ""; ?>"/>
      </div>
    </div>
    <div class="form-group">
      <label class="col-sm-3 control-label">Component Name:</label>
      <div class="col-sm-8">
        <input type="text" class="form-control" placeholder="component" name="componentName"
               value="<?php echo isset($_POST['componentName']) ? $_POST['componentName'] : ""; ?>"/>
      </div>
    </div>
    <br/>
    <hr/>
